...
CREATE TABLE `user` (
  ...
  `shop_id_user` bigint DEFAULT NULL,
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `username_UNIQUE` (`username`),
  KEY `role_id_idx` (`role_id_user`),
  KEY `shop_id_idx` (`shop_id_user`),
  CONSTRAINT `role_id_user` FOREIGN KEY (`role_id_user`) REFERENCES `role` (`role_id`),
  CONSTRAINT `shop_id_user` FOREIGN KEY (`shop_id_user`) REFERENCES `shop` (`shop_id`)
...
INSERT INTO `user` VALUES (1,'Thang Ngo','thangngo','1','thangngo@gmail.com','070266608',1,'1998-03-03','Quang Nam',1,NULL,NULL,NULL,NULL,2,NULL),(2,'Binh An','binhan','1','binhan@gmail.com','07025133652',0,'1999-01-01','Da Nang',0,NULL,NULL,NULL,NULL,2,NULL),(3,'Admin','admin','123456','admin@gmail.com','03212364125',0,'1995-01-01','Ha Noi',1,NULL,NULL,NULL,NULL,1,NULL);
