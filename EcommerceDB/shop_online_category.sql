...
CREATE TABLE `category` (
  ...
  `cate_name` varchar(45) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `cate_description` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `isActive` tinyint NOT NULL,
  `categorycol` varchar(45) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
